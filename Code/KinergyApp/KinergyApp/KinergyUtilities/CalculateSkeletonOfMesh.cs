...
{
    public class CalculateSkeletonOfMesh : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the CalculateSkeletonOfMesh class.
        /// </summary>
        public CalculateSkeletonOfMesh()
          : base("CalculateSkeletonOfMesh", "Nickname",
              "Description",
              "Kinergy", "Utilities")
        {
        }
        ...
        {
            pManager.AddMeshParameter("Mesh", "M", "The mesh to be calculated", GH_ParamAccess.item);
        }
        ...
        {
            get { return new Guid("fb407798-d8e1-4f00-a233-bf7c03a55c82"); }
        }
    }
}