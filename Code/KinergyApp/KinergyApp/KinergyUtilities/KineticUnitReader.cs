...
{
    public class KineticUnitReader : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the MotionReader class.
        /// </summary>
        public KineticUnitReader()
          : base("KineticUnitReader", "KUR",
              "Read entities from a kinetic unit and extract their brep models",
              "Kinergy", "Utilities")
        {
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            {
                if(e.GetType()==typeof(Helix) || e.GetType() == typeof(Gear) || e.GetType() == typeof(Spiral) || e.GetType() == typeof(Rack))
                {
