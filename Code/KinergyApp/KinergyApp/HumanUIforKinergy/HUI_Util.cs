...
using HumanUIforKinergy.Components;
using System.Data;
using MahApps.Metro.Controls;
using Rhino.Geometry;
using RangeSlider = MahApps.Metro.Controls.RangeSlider;

namespace HumanUIforKinergy
{
    ...
    static class HUI_Util
    {
        ...
        public static T GetUIElement<T>(object o) where T : UIElement
        {
            ...
            {
                case "HumanUIforKinergy.UIElement_Goo":
        ...
        {
            if (element is Panel && !(element is HumanUIforKinergy.ClickableShapeGrid) && !(element is HumanUIforKinergy.FilePicker))
            {
            ...
            try
            {
                switch (u.GetType().ToString())
                {
                    ...
                    case "HumanUIforKinergy.HUI_GradientEditor":
                        ...
                        return;
                    case "HumanUIforKinergy.FilePicker":
        ...
        static public object GetElementValue(UIElement u)
        {
            switch (u.GetType().ToString())
            {
                ...
                case "HumanUIforKinergy.TrueOnlyButton":
                ...
                case "HumanUIforKinergy.HUI_RhPickButton":
                ...
                case "HumanUIforKinergy.FilePicker":
                    FilePicker fp = u as FilePicker;
                    return fp.Path;
                case "HumanUIforKinergy.ClickableShapeGrid":
