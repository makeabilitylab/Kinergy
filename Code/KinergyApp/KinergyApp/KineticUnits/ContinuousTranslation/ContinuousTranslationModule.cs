        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (toSetEEPos)
            {
                ...
                else
                {
                    ...
                    #endregion
                    motion.AddGears(gears,axel_spacer_entities);
                }
                #endregion
            }
            ...
            if (toSetAxisDir)
            {
                ...
                //motion.EntityList.Add(rack);
                //foreach(Brep b in constrainingStructure)
                //{
                //    motion.EntityList.Add(new Entity(b,false,"constraining structure"));
                //}
                //if(connectingStructure!=null)
                //motion.EntityList.Add(new Entity(connectingStructure,false,"connecting structure"));
