...
namespace ConRotation
{
    public class ContinuousRotationModule : GH_Component
    {
        ...
        int eeMovingDirectionSelection = 0;//-1 for error, 0 for unset, 1 for CW, 2 for CCW
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (!DA.GetData(10, ref bake_input))
                return;
            if (!DA.GetData(11, ref revdir_input))
                return;
            #endregion
            ...
            if(toSetEEPos)
            {
                ...
                axel_spacer_entities = helperFun.genAxelsStoppers(selectedGearTrainParam.parameters, model, motionControlMethod);//Xia's note: reduced by 0.05 to make tighter
                #endregion
