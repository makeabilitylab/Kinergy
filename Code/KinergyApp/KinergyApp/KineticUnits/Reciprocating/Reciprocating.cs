...
namespace HumanUIforKinergy.KineticUnits.Reciprocating
{
    public class Reciprocating:KineticUnit
    {
        Brep model;
        Brep innerCylinder;
        ...
        public Reciprocating(Brep M,Brep IC,Vector3d D,double Str,double Dis,bool addLock=true,int camTypeValue=1)
        {
            model = M;
            innerCylinder = IC;
