...
namespace HumanUIforKinergy.Upgraders
{
    public class Upgrade_GridComponent : IGH_UpgradeObject
    {
        ...
        public IGH_DocumentObject Upgrade(IGH_DocumentObject target, GH_Document document)
        {
            ...
            HumanUIforKinergy.Components.UI_Containers.CreateGrid_Component testComp = new Components.UI_Containers.CreateGrid_Component();
