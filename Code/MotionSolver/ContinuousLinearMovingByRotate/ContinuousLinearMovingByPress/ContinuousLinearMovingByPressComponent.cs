...
{
    public class ContinuousLinearMovingByPressComponent : GH_Component
    {
        /// <summary>
        ...
        /// </summary>
        public ContinuousLinearMovingByPressComponent()
          : base("ContinuousLinearMovingByPress", "CLMP",
              "Description",
        ...
        {
            get { return new Guid("1056bbe9-6be8-45ec-b674-56283f96e4b2"); }
        }
    }
}
