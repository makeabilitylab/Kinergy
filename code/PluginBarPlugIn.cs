...
namespace EnergyPlugin
{
    ...
    public class PluginBarPlugIn : PlugIn
    {
        ...
        /// </summary>
        public EnergyPluginControl DockBarUserControl
        {
            get;
            private set;
        }
        ...
        protected override LoadReturnCode OnLoad(ref string errorMessage)
        {
            ...
            DockBarUserControl = new EnergyPluginControl();
            RhinoModel rhinoModel = new IncRhinoModel();

            Controller control = new IncController(DockBarUserControl, rhinoModel);

            // Create our dock bar
            DockBarDialog = new PluginBarDialog(PluginBarDialog.DockBarId(), "edaCAD Plugin Side Panel", DockBarUserControl);
            ...
            MRhinoDockBarManager.CreateRhinoDockBar(
              ...
              MRhinoUiDockBar.DockStyle.left,
              new Point(0, 0)
              );

            
            DockBarDialog.Initialize();
            DockBarDialog.ResizeFloating(new Size(500, 812));
            DockBarDialog.SetInitialSizeFloating(new Size(500, 812));
            DockBarDialog.SetInitialSizeDockedVert(new Size(500, 812));
            DockBarDialog.SetSizeRange(MRhinoUiDockBar.DockLocation.left, new Size(500, 100), new Size(500, 812));
