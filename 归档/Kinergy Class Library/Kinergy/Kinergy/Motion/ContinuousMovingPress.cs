...
namespace Kinergy
{
    namespace Motion
    {
        public class ContinuousMovingPress:Motion
        {
            ...
            public Spring SpringEntity { get => springEntity;protected set => springEntity = value; }
            ...
            private bool ConstructSpring()
            {
                ...
                springEntity = new Spring(startPoint, endPoint, springRadius, wireRadius, roundNum);
            ...
            private bool ConstructRack()
            {
                ...
                Point3d endPoint = startPoint - springDirection / springDirection.Length * springLength * distance*3;//TODO get rid of the 2
